...
editUserFront.addEventListener("submit", function(e){
    let errors={
        ...
        if(campoNombre.value.length==0){
            ...
            errors.name.push('El campo de nombre debe estar completo')
            
        } else if(campoNombre.value.length<2){
            errors.name.push('El campo de nombre debe tener al menos 2 caracteres')
        ...
        if(campoApellido.value.length==0){
            errors.lastname.push('El campo de apellido debe estar completo')

        } else if(campoApellido.value.length<2){
        errors.lastname.push('El campo de apellido debe tener al menos 2 caracteres')
